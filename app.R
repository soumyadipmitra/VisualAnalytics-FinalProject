...
ui <- fluidPage(
    navbarPage("FosterCare and Adoption",theme = shinytheme("superhero"),
      ...
      Foster care is intended to provide temporary, safe living arrangements and therapeutic services for children who cannot remain safely at home because of risk for maltreatment or inadequate care.Foster care arrangements include non-relative foster homes, relative foster homes (also known as “kinship care”), group homes, institutions, and pre-adoptive homes."), 
                 tags$p("Our domain problem is one for a socialworker wanting to provide support and services to the foster kids.But a social worker can only access existing resources in a community. If no resources exist, 
      ...
      tabPanel("References",
               ...
               div(
                 ...
                 a(href="https://github.com/soumyadipmitra/VisualAnalytics-FinalProject", "https://github.com/soumyadipmitra/VisualAnalytics-FinalProject")
                 , style='text-align:left'
               ),
               br(),
               ...
               div(
                 ...
                 a(href="https://github.com/soumyadipmitra/VisualAnalytics-FinalProject",
