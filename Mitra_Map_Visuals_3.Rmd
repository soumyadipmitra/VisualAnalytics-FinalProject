...
```{r}
write_csv(state_data,"State_Data.csv")
```
...
```{r}
#Set hover text
us_states_mapped$hover <- with(us_states_mapped,paste(STATE_NAME,'<br>',"Year: ",year,
                                    '<br>',"Served: ", Served,", Entered: ", Entered,
                                    '<br>',"In Case as of Sep 30: ", InCare_Sep30,
                                    '<br>',"Exited: ", Exited,
                                    '<br>',"Waiting Adoption: ",Waiting_Adoption,
                                    '<br>',"Parental Rights Terminated",parental_rights_terminated,
                                    '<br>',"Adopted: ",adopted))
